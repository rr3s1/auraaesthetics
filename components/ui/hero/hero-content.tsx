    ...
    >
      ...
      >
        <AnimatedText
          ...
          textClassName="text-5xl font-bold cinzel-decorative-black text-center leading-tight tracking-wide sm:text-5xl sm:leading-tight md:text-8xl md:leading-tight lg:text-8xl lg:leading-normal text-white"
          style={{
