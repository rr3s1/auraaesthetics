    ...
    >
      <div>
        ...
        <AnimatedText
          ...
          el="p"
          className="text-2xl lg:text-3xl opacity-80 mb-8"
        ...
        <AnimatedBlock variants={simpleFadeInUp} delay={0.3}>
          <Link href="#" legacyBehavior>
            <a className="text-pink-400 hover:text-pink-300 font-semibold text-2xl inline-block transform hover:translate-x-1 transition-transform duration-200">
      ...
      <AnimatedBlock variants={imageDramaticRevealVariants} className="text-center">
        <img src="/client_SCase.png" alt="Client showcasing natural-looking aesthetic results" className="rounded-lg shadow-2xl mx-auto w-full max-w-md"/>
      </AnimatedBlock>
    </motion.section>
  );
}
