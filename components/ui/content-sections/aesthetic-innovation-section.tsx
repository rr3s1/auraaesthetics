  ...
  return (
    ...
    >
      <AnimatedBlock variants={imageDramaticRevealVariants} className="text-center md:order-2">
        <img src="/Intruments.png" alt="State-of-the-art aesthetic technology in a clinic setting" className="rounded-lg shadow-2xl mx-auto w-full max-w-md"/>
      </AnimatedBlock>
      <div className="md:order-1">
        ...
        <AnimatedBlock variants={simpleFadeInUp} delay={0.3}>
          <Link href="#" legacyBehavior>
            <a className="text-teal-400 hover:text-teal-300 font-semibold text-2xl inline-block transform hover:translate-x-1 transition-transform duration-200">
